 ...
 */
public class LongReferenceConcurrentHashMap<V> extends AbstractMap<Long, V>
    ...
    private static final long serialVersionUID = 5075742530507474303L;
    ...
    public static final class Segment<V> extends ReentrantLock implements Serializable {
         ...
         * When nodes would othernextwise be changed, new nodes are
            ...
            for (int i = 0; i < oldCapacity; i++) {
                ...
                if (e != null) {
                    ...
                    if (next == null)
                        ...
                        int lastIdx = idx;
                        for (
                                HashEntry<V> last = next; last != null; last = last.next) {
     ...
     *                                  nonpositive.
     */
    public LongReferenceConcurrentHashMap(int initialCapacity /*,float loadFactor*/, int concurrencyLevel) {
        ...
        try {
            ...
            segmentMask = ssize - 1;
            //            setFinalStatic(LongReferenceConcurrentHashMap.class.getDeclaredField("segmentMask"), ssize - 1);
            //            setFinalStatic(LongReferenceConcurrentHashMap.class.getDeclaredField("segmentShift"), 32 - sshift);
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            LongReferenceConcurrentHashMap.this.remove(lastReturned.key);
            lastReturned = null;
        }
    }
    ...
    final class WriteThroughEntry extends SimpleEntry<Long, V> {
        ...
        public V setValue(V value) {
            ...
            LongReferenceConcurrentHashMap.this.put(getKey(), value);
            return v;
        }
    }
    ...
    public final class LongKeySet extends AbstractSet<Long> {
        ...
        public boolean contains(Object o) {
            return LongReferenceConcurrentHashMap.this.containsKey(o);
        }

        public boolean remove(Object o) {
            return LongReferenceConcurrentHashMap.this.remove(o) != null;
        }
