 ...
 * <!-- 在此添加修改列表，参考第一行内容 -->
 * <tr><td>1</td><td>Oliver</td><td>2008-10-12 下午07:19:24</td><td>建立类型</td></tr>
 * 
 * </table>
 * @version 1.0
 * @author Oliver
...
public final class Formatter
{
	 ...
	 * <p><b>详细说明：</b></p>
	 * <!-- 在此添加详细说明 -->
	 * 把长字符串格"abcdef"格式化成形如"abc..."的字符串。
	 * @param src - 源字符串
	 * @param length - 格式化后长度
	 * @param suffixLength - 格式化后缀长度
	 * @param suffix - 省略后缀
	 * @return format 字符串
	 */
	public static String forShortFormat(String src,int length,int suffixLength,char suffix)
	{
		...
		src=src.substring(0,(length-suffixLength));
